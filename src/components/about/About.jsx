...
export default function About() {
    useEffect(() => {
        ...
        return ()=>{document.querySelector('.nav-bar').classList.remove('in-about')}
    }, [])
        ...
        <div className='about-container'>
            <div className="about-hero-container">
                ...
                <div className="about-banners">
                    ...
                    <div className='about-banner'>Whether you're looking for the latest blockbuster release or a classic board game, we have something for everyone. Our friendly and knowledgeable staff is always on hand to help you find the perfect game for your needs.</div>
            ...
            <div className="about-introduction">
                <h3>React Zone About Page</h3>
                <div className="about-text-container">
                    <p>Welcome to React Zone, the ultimate destination for all your gaming needs. Our app was developed as a personal project by Orlando Umanzor, with the goal of providing an easy and convenient way for gamers to discover and purchase the latest and greatest games.</p>
